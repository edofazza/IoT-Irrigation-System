...
PROCESS(rain_server, "Server for the rain sensor");
AUTOSTART_PROCESSES(&rain_server);
...
extern coap_resource_t rain_sensor;
...
//*************************** THREAD *****************************//
PROCESS_THREAD(rain_server, ev, data)
{
    PROCESS_BEGIN();
    ...
    LOG_INFO("REGISTERED\nStarting rain server");
    
    // RESOURCES ACTIVATION
    coap_activate_resource(&rain_sensor, "rain_sensor");
